        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center space-x-4 pt-2">
              <a href="#" className="w-8 h-8 rounded-full bg-white/5 flex items-center hover:bg-primary/25 hover:text-white transition-colors duration-200 justify-center text-gray-400" aria-label="Instagram">
              ...
              <a href="#" className="w-8 h-8 rounded-full bg-white/5 flex items-center hover:bg-primary/25 hover:text-white transition-colors duration-200 justify-center text-gray-400" aria-label="LinkedIn">
                <svg className="w-4 h-4 fill-none stroke-current" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24">
